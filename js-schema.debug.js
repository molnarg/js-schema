...
Array.of = function() {
  ...
  if(args.length == 3){
      if(!(typeof args[0] === "number")){
          throw new Error("3 arguments were passed to Array.of and 1st argument (minLength) SHOULD be number!")
      }
      if(!(typeof args[1] === "number")){
          throw new Error("3 arguments were passed to Array.of and 2nd argument (maxLength) SHOULD be number!")
      }
  }
  if (args.length === 2) {
      if(!(typeof args[1] === "number")){
          throw new Error("2 arguments were passed to Array.of and 1nd argument (length) SHOULD be number!")
      }
      args[2] = args[1]
  }
