...
ObjectSchema.prototype.validate = function(instance) {
...
ObjectSchema.prototype.toJS = function() {
  var object = {}
  
  for (var property in this.reference) object[property] = this.reference[property].toJS()
